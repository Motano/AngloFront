    ...
    return(
        ...
        <GridItem xs={12} sm={12} md={12}>
            ...
            <CardHeader color="primary">
                <h4 className="cardTitleWhite">Planta LB</h4>
            ...
            <CardBody>
                ...
                <tbody>
                    <tr>
                    <td className="text-dark table-primary">Hrs posibles Molienda N°1 LB</td>
                    {tableData[0]}
                    </tr>
                    <tr>
                    <td className="text-dark table-primary">Hrs posibles Molienda N°2 LB</td>
                    {tableData[0]}
                    </tr>
                    <tr>
